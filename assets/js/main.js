(function() {
  ...
  /**
   * Défilement avec décalage sur les liens avec un nom de classe .scrollto
   */
  ...
  /**
   * Faites défiler avec décalage au chargement de la page avec des liens de hachage dans l'url
   */
  ...
  /**
   * Isotope et filtre du portefolio
   */
  window.addEventListener('load', () => {
  ...
  /**
   * Lancer la lightbox du portefeuille
   */
  ...
  /**
   * Curseur des détails du portefeuille
   */
